...
#azure functions
resource "azurerm_function_app" "function_app_recipes" {
  ...
  app_service_plan_id        = azurerm_service_plan.service_plan_homecook_azure_functions.id
...
resource "azurerm_function_app" "function_app_files" {
